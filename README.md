...
- **Cross-Lingual Vision-Language Models**: Evaluating CLIP's performance on Japanese vs English memes ([repo](https://github.com/maliha-usui/cross-lingual-clip-memes))
...
2. **Mamun, M.B.** (2025). "Sarcasm-Aware Hate Speech Detection Using Rationales." *Journal of the Japanese Society for Artificial Intelligence*, 40(1), 1058-1059.
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=flat&logo=linkedin&logoColor=white)]([https://linkedin.com/in/malihabintemamun](https://www.linkedin.com/public-profile/settings))
[![Email](https://img.shields.io/badge/Email-D14836?style=flat&logo=gmail&logoColor=white)](mailto:bintemaliha19@gmail.com)

---

💡 *Note: My current industry work at Pi Photonics is maintained on the company's private GitLab server. This GitHub showcases my independent research in multimodal ML and NLP.*
